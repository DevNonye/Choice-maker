...
class App extends Component {
    ...
    handleInputChange = (optionValues, question) => {
        ...
        return ( <
            ...
            main > {
                this.state.active === "FORM" ? ( <
                    Form viewPopularity = { this.viewPopularity }
                    getInputValues = { this.getInputValues }
                    />
                ) : this.state.active === "DISPLAY-OPTIONS" ? ( <
                    DisplayInputs viewPopularity = { this.viewPopularity }
                    ...
                    Popularity clearList = { this.clearList }
